function evaluate_and_save_points_main_points(points, bounds)
    ...
    fileName = sprintf('IO_regression_By_DOE_with_Noise_%d_main_points_noncumulated.xlsx', points_count);
    ...
    figure;
    plot(GluIn_mean_vect, Qin_DOE, 'o')
    ylabel('Input flow rate [L/d]');
    xlabel('Input glucose [g/L]');
end