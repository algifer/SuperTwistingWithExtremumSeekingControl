...
function dy = H2ReactorLIPATA2RODEDiff(t, y, flag, GluIn, Qin, V, Vgas, K, H2MM, muMax, KGlu, KHCO2, KHH2, KlaCO2, KlaH2, Patm, pVapH2O, R, TReac, TAmb, al, be, ga, p, q, k1, k2)
...
% Dilution rate
D       = (Qin/V);
J       = ((R*TAmb)/(Patm-pVapH2O))*((rhoTH2/H2MM));    %Tasa de produccion de H_2
