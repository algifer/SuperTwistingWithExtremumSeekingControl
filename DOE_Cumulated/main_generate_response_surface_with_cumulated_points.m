...
%% Cumulated Model (30 points - best model)
filename_doe = 'IO_regression_By_DOE_with_Noise_30_cumulated.xlsx';
filename_trained = 'trainedModel_with_30_sample_cumulated.mat';
...
for j=1:lQin
    for k=1:lGluIn
        ...
        Hpr_fit(j,k) = trainedModel.predictFcn(TI);
    end
end
